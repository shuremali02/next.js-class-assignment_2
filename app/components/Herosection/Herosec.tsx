...
//       <h1 className='font-bold leading-loose mt-4 text-2xl md:text-5xl'>We Create  <br /> <span className='text-orange-600 mr-2 '>
//         Solution
//       </span>
...
//       </p>
//       <div className='space-y-4 flex flex-col '><Link href={"#"} >
//         <Button className='py-2 px-4'>Get Started</Button>  </Link> 
//          <Link href={"#"} >
//          <Button variant={'outline'} className='py-2 px-4 gap-x-1'> <BsFillArrowDownRightCircleFill/>Explore Now </Button>
//          </Link>
//       </div>
//          </div>
